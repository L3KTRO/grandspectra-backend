...
/**
* @see \App\Http\Controllers\PersonController::meili
* @see app/Http/Controllers/PersonController.php:37
* @route '/api/meili/people'
*/
...
const PersonController = { index, show, meili }
