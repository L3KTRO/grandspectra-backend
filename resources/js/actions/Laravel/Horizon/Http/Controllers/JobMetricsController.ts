...
* @route '/dashboard/horizon/api/metrics/jobs'
*/
...
index.definition = {
    methods: ["get","head"],
    url: '/dashboard/horizon/api/metrics/jobs',
...
* @route '/dashboard/horizon/api/metrics/jobs/{id}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/horizon/api/metrics/jobs/{id}',
} satisfies RouteDefinition<["get","head"]>
