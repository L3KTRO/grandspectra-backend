...
* @route '/dashboard/telescope/telescope-api/models'
*/
...
index.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/models',
...
* @route '/dashboard/telescope/telescope-api/models/{telescopeEntryId}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/models/{telescopeEntryId}',
