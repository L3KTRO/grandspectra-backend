...
* @route '/dashboard/telescope/telescope-api/client-requests'
*/
...
index.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/client-requests',
...
* @route '/dashboard/telescope/telescope-api/client-requests/{telescopeEntryId}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/client-requests/{telescopeEntryId}',
