...
* @route '/dashboard/telescope/telescope-api/schedule'
*/
...
index.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/schedule',
...
* @route '/dashboard/telescope/telescope-api/schedule/{telescopeEntryId}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/schedule/{telescopeEntryId}',
