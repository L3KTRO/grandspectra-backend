...
* @route '/dashboard/telescope/telescope-api/monitored-tags'
*/
...
index.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/monitored-tags',
...
* @route '/dashboard/telescope/telescope-api/monitored-tags/delete'
*/
...
destroy.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/monitored-tags/delete',
} satisfies RouteDefinition<["post"]>
