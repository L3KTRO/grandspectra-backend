...
* @route '/dashboard/telescope/telescope-api/batches'
*/
...
index.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/batches',
...
* @route '/dashboard/telescope/telescope-api/batches/{telescopeEntryId}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/batches/{telescopeEntryId}',
