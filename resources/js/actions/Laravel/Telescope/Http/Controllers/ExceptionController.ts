...
* @route '/dashboard/telescope/telescope-api/exceptions'
*/
...
index.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/exceptions',
...
* @route '/dashboard/telescope/telescope-api/exceptions/{telescopeEntryId}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/exceptions/{telescopeEntryId}',
