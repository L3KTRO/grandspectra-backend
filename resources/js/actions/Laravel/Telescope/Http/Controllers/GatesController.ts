...
* @route '/dashboard/telescope/telescope-api/gates'
*/
...
index.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/gates',
...
* @route '/dashboard/telescope/telescope-api/gates/{telescopeEntryId}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/gates/{telescopeEntryId}',
