...
* @route '/dashboard/telescope/telescope-api/logs'
*/
...
index.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/logs',
...
* @route '/dashboard/telescope/telescope-api/logs/{telescopeEntryId}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/logs/{telescopeEntryId}',
