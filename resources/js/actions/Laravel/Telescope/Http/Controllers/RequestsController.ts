...
* @route '/dashboard/telescope/telescope-api/requests'
*/
...
index.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/requests',
...
* @route '/dashboard/telescope/telescope-api/requests/{telescopeEntryId}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/requests/{telescopeEntryId}',
