...
* @route '/dashboard/telescope/telescope-api/jobs'
*/
...
index.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/jobs',
...
* @route '/dashboard/telescope/telescope-api/jobs/{telescopeEntryId}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/jobs/{telescopeEntryId}',
