...
* @route '/dashboard/telescope/telescope-api/mail'
*/
...
index.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/mail',
...
* @route '/dashboard/telescope/telescope-api/mail/{telescopeEntryId}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/mail/{telescopeEntryId}',
