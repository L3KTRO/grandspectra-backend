...
* @route '/dashboard/telescope/telescope-api/events'
*/
...
index.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/events',
...
* @route '/dashboard/telescope/telescope-api/events/{telescopeEntryId}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/events/{telescopeEntryId}',
