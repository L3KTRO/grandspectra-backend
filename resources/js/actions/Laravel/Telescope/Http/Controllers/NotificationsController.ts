...
* @route '/dashboard/telescope/telescope-api/notifications'
*/
...
index.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/notifications',
...
* @route '/dashboard/telescope/telescope-api/notifications/{telescopeEntryId}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/notifications/{telescopeEntryId}',
