...
* @route '/dashboard/telescope/telescope-api/views'
*/
...
index.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/views',
...
* @route '/dashboard/telescope/telescope-api/views/{telescopeEntryId}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/views/{telescopeEntryId}',
