...
* @route '/dashboard/telescope/telescope-api/redis'
*/
...
index.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/redis',
...
* @route '/dashboard/telescope/telescope-api/redis/{telescopeEntryId}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/redis/{telescopeEntryId}',
