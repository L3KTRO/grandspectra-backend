...
* @route '/dashboard/telescope/telescope-api/commands'
*/
...
index.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/commands',
...
* @route '/dashboard/telescope/telescope-api/commands/{telescopeEntryId}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/commands/{telescopeEntryId}',
