...
* @route '/dashboard/telescope/telescope-api/cache'
*/
...
index.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/cache',
...
* @route '/dashboard/telescope/telescope-api/cache/{telescopeEntryId}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/cache/{telescopeEntryId}',
