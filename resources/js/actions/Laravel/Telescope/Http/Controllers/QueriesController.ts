...
* @route '/dashboard/telescope/telescope-api/queries'
*/
...
index.definition = {
    methods: ["post"],
    url: '/dashboard/telescope/telescope-api/queries',
...
* @route '/dashboard/telescope/telescope-api/queries/{telescopeEntryId}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/telescope/telescope-api/queries/{telescopeEntryId}',
